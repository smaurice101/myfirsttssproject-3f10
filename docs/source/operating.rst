[myfirsttssproject-3f10] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [myfirsttssproject-3f10] container is NOT running**.

.. tip::
   You must have your [myfirsttssproject-3f10] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=43695  \-\-env VIPERVIZPORT=44343  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:44343/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:44343/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   maadsdocker/myfirsttssproject-3f10-amd64 (https://hub.docker.com/r/maadsdocker/myfirsttssproject-3f10-amd64)
...
.. important::
   docker run -d -p 47721:47721 -p 56449:56449 -p 50273:50273 \-\-env TSS=0 \-\-env SOLUTIONNAME=myfirsttssproject-3f10 \-\-env SOLUTIONDAG=solution_preprocessing_dag-myfirsttssproject-3f10 \-\-env GITUSERNAME=smaurice101  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=47721  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=56449  \-\-env SOLUTIONVIPERVIZPORT=50273 \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env EXTERNALPORT=43695 \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env VIPERVIZPORT=44343 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  maadsdocker/myfirsttssproject-3f10-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=50273
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=47721
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - maadsdocker/myfirsttssproject-3f10-amd64
...
It can be accessed by entering: http://localhost:56449
...
.. important::
   http://localhost:50273/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:50273/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:50273/<html file>
...
[myfirsttssproject-3f10] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/myfirsttssproject-3f10
...
.. important::
   https://myfirsttssproject-3f10.readthedocs.io
...
.. important::
   solution_preprocessing_dag-myfirsttssproject-3f10
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=47721, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=36263, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=35757, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=39829, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=37897, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=36947, HPDEHOST=127.0.1.1, HPDEPORT=40249, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=40717
